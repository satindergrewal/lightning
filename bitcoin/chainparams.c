...
const struct chainparams networks[] = {
    ...
    {.network_name = "chips",
     .bip173_name = "chips",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0x00, 0x00, 0x00, 0x6e, 0x75, 0xf6, 0xaa,
                      0x0e, 0xfd, 0xbf, 0x7d, 0xb0, 0x31, 0x32,
                      0xaa, 0x4e, 0x4d, 0x0c, 0x84, 0x95, 0x15,
                      0x37, 0xa6, 0xf5, 0xa7, 0xc3, 0x9a, 0x0a,
                      0x9d, 0x30, 0xe1, 0xe7}}}},
     .rpc_port = 57776,
     .cli = "chips-cli",
     .cli_args = NULL,
